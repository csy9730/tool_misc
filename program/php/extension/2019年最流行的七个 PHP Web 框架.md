...
在我们谈论 PHP 框架时，一般会想到模型视图控制器（MVC）。当您希望将业务逻辑与 Web UI 分离，并对它们进行分层编程时，MVC 是不错的选择。简单来说，PHP MVC 框架将开发过程分解为模块。由此，Web 开发人员可以在不影响其他模块的情况下处理单个模块的业务逻辑，分工更为清晰，效率也更高。
