...
# gzip
tar -czf archive.tar.gz foo bar  # 从文件 foo 和 bar 创建归档文件archive.tar.gz。
tar -xzf archive.tar .gz         # 解开归档文件 archive.tar.gz中的所有文件。
...
```
(base) admin@m1808-devel:~/Project$ tar --help
用法: tar [选项...] [FILE]...
GNU ‘tar’
