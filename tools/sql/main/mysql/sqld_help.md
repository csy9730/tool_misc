...
```
C:\Program Files\MySQL\MySQL Server 8.0\bin\mysqld.exe  Ver 8.0.11 for Win64 on x86_64 (MySQL Community Server - GPL)
...
Usage: C:\Program Files\MySQL\MySQL Server 8.0\bin\mysqld.exe [OPTIONS]
...
--login-path=#          Read this path from the login file.
  ...
  --innodb-log-checkpoint-every=# 
                      Checkpoints are executed at least every that many
                      milliseconds.
  ...
  --innodb-log-closer-spin-delay=# 
                      Number of spin iterations, for which log closer thread is
                      waiting for dirty pages added.
  --innodb-log-closer-timeout=# 
                      Initial sleep time in log closer thread (microseconds)
  ...
  --innodb-log-flush-events=# 
                      Number of events used for notifications about log flush.
  --innodb-log-flush-notifier-spin-delay=# 
                      Number of spin iterations, for which log flush notifier
                      thread is waiting for advanced flushed_to_disk_lsn,
                      without sleeping.
  --innodb-log-flush-notifier-timeout=# 
                      Initial timeout used to wait on event in log flush
                      notifier thread (microseconds)
  --innodb-log-flusher-spin-delay=# 
                      Number of spin iterations, for which log flusher thread
                      is waiting for new data to flush, without sleeping.
  --innodb-log-flusher-timeout=# 
                      Initial timeout used to wait on event in log flusher
                      thread (microseconds)
  --innodb-log-group-home-dir=name 
                      Path to InnoDB log files.
  --innodb-log-recent-closed-size=# 
                      Size of a small buffer, which allows to break requirement
                      for total order of dirty pages, when they are added to
                      flush lists.
  --innodb-log-recent-written-size=# 
                      Size of a small buffer, which allows concurrent writes to
                      log buffer.
  ...
  --innodb-log-wait-for-flush-spin-delay=# 
                      Number of spin iterations, when spinning and waiting for
                      log flushed.
  ...
  --innodb-log-wait-for-write-spin-delay=# 
                      Number of spin iterations, when spinning and waiting for
                      log buffer written up to given LSN, before we fallback to
                      loop with sleeps. This is not used when user thread has
                      to wait for log flushed to disk.
  ...
  --innodb-log-write-events=# 
                      Number of events used for notifications about log write.
  --innodb-log-write-max-size=# 
                      Size available for next write, which satisfies log_writer
                      thread when it follows links in recent written buffer.
  --innodb-log-write-notifier-spin-delay=# 
                      Number of spin iterations, for which log write notifier
                      thread is waiting for advanced write_lsn, without
                      sleeping.
  --innodb-log-write-notifier-timeout=# 
                      Initial timeout used to wait on event in log write
                      notifier thread (microseconds)
  --innodb-log-writer-spin-delay=# 
                      Number of spin iterations, for which log writer thread is
                      waiting for new data to write without sleeping.
  --innodb-log-writer-timeout=# 
                      Initial timeout used to wait on event in log writer
                      thread (microseconds)
  ...
  --ssl-fips-mode=name 
                      ssl fips mode, permitted values are OFF, ON, STRICT (Only
                      for openssl)
...
character-sets-dir                                           E:\Program Files\MySQL\MySQL Server 8.0\share\charsets\
...
gdb                                                          FALSE
general-log                                                  FALSE
general-log-file                                             E:\Program Files\MySQL\MySQL Server 8.0\data\DESKTOP-CTAGE42.log
...
innodb-log-checkpoint-every                                  1000
innodb-log-checksums                                         TRUE
innodb-log-closer-spin-delay                                 0
innodb-log-closer-timeout                                    1000
innodb-log-compressed-pages                                  TRUE
innodb-log-file-size                                         50331648
innodb-log-files-in-group                                    2
innodb-log-flush-events                                      2048
innodb-log-flush-notifier-spin-delay                         0
innodb-log-flush-notifier-timeout                            10
innodb-log-flusher-spin-delay                                25000
innodb-log-flusher-timeout                                   10
innodb-log-group-home-dir                                    (No default value)
innodb-log-recent-closed-size                                2097152
innodb-log-recent-written-size                               1048576
innodb-log-spin-cpu-abs-lwm                                  80
innodb-log-spin-cpu-pct-hwm                                  50
innodb-log-wait-for-flush-spin-delay                         25000
innodb-log-wait-for-flush-spin-hwm                           400
innodb-log-wait-for-flush-timeout                            1000
innodb-log-wait-for-write-spin-delay                         25000
innodb-log-wait-for-write-timeout                            1000
innodb-log-write-ahead-size                                  8192
innodb-log-write-events                                      2048
innodb-log-write-max-size                                    4096
innodb-log-write-notifier-spin-delay                         0
innodb-log-write-notifier-timeout                            10
innodb-log-writer-spin-delay                                 25000
innodb-log-writer-timeout                                    10
...
language                                                     E:\Program Files\MySQL\MySQL Server 8.0\share\
lc-messages                                                  en_US
lc-messages-dir                                              E:\Program Files\MySQL\MySQL Server 8.0\share\
lc-time-names                                                en_US
local-infile                                                 FALSE
...
performance-schema-error-size                                4376
...
pid-file                                                     E:\Program Files\MySQL\MySQL Server 8.0\data\DESKTOP-CTAGE42.pid
plugin-dir                                                   E:\Program Files\MySQL\MySQL Server 8.0\lib\plugin\
port                                                         3306
port-open-timeout                                            0
...
relay-log                                                    DESKTOP-CTAGE42-relay-bin
relay-log-index                                              DESKTOP-CTAGE42-relay-bin.index
...
slave-load-tmpdir                                            C:\Users\admin\AppData\Local\Temp
...
slow-query-log-file                                          E:\Program Files\MySQL\MySQL Server 8.0\data\DESKTOP-CTAGE42-slow.log
