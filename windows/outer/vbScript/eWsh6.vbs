...
WScript.Echo x, y
oExcel.Run "SetCursor", 30, 60 '设置鼠标 X Y 坐标
...
'模拟鼠标左键双击（即快速的两次单击）
WScript.Sleep 3000
REM oExcel.Run "SetCursor", 50, 60 '设置鼠标 X Y 坐标
oExcel.Run "mouse_event", MOUSEEVENTF_LEFTDOWN + MOUSEEVENTF_LEFTUP, 0, 0, 0, 0
oExcel.Run "mouse_event", MOUSEEVENTF_LEFTDOWN + MOUSEEVENTF_LEFTUP, 0, 0, 0, 0
'模拟鼠标右键单击
WScript.Sleep 3000
oExcel.Run "SetCursor", 90, 60 '设置鼠标 X Y 坐标
oExcel.Run "mouse_event", MOUSEEVENTF_RIGHTDOWN + MOUSEEVENTF_RIGHTUP, 0, 0, 0, 0
'模拟鼠标中键单击
WScript.Sleep 3000
oExcel.Run "SetCursor", 70, 90 '设置鼠标 X Y 坐标
